...
【ふりがな（ルビ）を必ず付ける】
title_ja / summary / take / overview の日本語の中の【すべての漢字】に読み仮名を付ける。
記法は必ず {漢字|かんじ} の形（波括弧で囲み、縦棒の左に漢字、右にひらがなの読み）。
- 熟語・固有名詞はまとめて1語にする。例: {経済|けいざい} {米国|べいこく} {岸田|きしだ}
- ひらがな・カタカナ・英数字・記号には付けない。読みは正確な現代仮名遣いで。
- 例文: {米国|べいこく}の{利上|りあ}げが{世界|せかい}の{株価|かぶか}に{影響|えいきょう}した。
